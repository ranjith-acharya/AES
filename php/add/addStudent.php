...
<head>
	...
	<script type="text/javascript" src="../../js/validateAddStudent.js"></script>
...
<section style="margin-top:20px;border-radius:5px;box-shadow:0px 0px 8px rgba(0,0,0,0.1);" class="bg-white container col-md-6 text-center">
	<form class="form text-center container" method="POST" action="push/student.php" enctype="multipart/form-data" style="padding-top:20px;padding-bottom:20px;" >
		<input type="text" name="addmission" id="addmissionbox" placeholder="Addmission Number" class="col-md-8"><br><br>	
		...
		<input type="file" name="avatar" id="avatarbox" class="col-md-12"><br><br>
		<input type="submit" name="studentData" id="studentDataSubmit" value="Submit Student Data" class="btn">
